...
import com.example.modmobilecustomer.databinding.FragmentProductListBinding
...
//                                Toast.makeText(this, it.message, Toast.LENGTH_SHORT).show()
    ...
    override fun BrandOnClick(position: Int, list: ArrayList<Data>, view: View, type:String, phoneName: String) {

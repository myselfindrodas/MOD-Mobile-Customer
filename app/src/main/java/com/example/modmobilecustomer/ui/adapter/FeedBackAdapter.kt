...
import com.example.modmobilecustomer.data.model.BudgetData
import com.example.modmobilecustomer.data.model.FeedBackData
import com.example.modmobilecustomer.data.model.reviewlistmodel.Data
...
class FeedBackAdapter(val context: Context, var onItemClickListener: FeedBackListOnItemClickListener)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FeedBackAdapter.classViewHolder {
        val view = inflater.inflate(R.layout.feedback_list, parent, false)
        return classViewHolder(view)
    }

    override fun onBindViewHolder(holder: FeedBackAdapter.classViewHolder, position: Int) {
        with(holder){

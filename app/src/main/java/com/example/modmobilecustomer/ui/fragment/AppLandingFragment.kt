...
import com.example.modmobilecustomer.data.model.dashboardmodel.BannerData
import com.example.modmobilecustomer.data.model.dashboardmodel.CategoryInfo
import com.example.modmobilecustomer.data.model.dashboardmodel.DashboardRequest
import com.example.modmobilecustomer.data.model.dashboardmodel.LatestEditionImg
import com.example.modmobilecustomer.data.model.dashboardmodel.ShopByBudgetImg
import com.example.modmobilecustomer.data.model.dashboardmodel.TopBrand
...
import com.example.modmobilecustomer.databinding.FragmentAppLandingBinding
import com.example.modmobilecustomer.ui.MainActivity
import com.example.modmobilecustomer.ui.SplashActivity
...
import com.example.modmobilecustomer.ui.adapter.CategoryListAdapter
...
import com.example.modmobilecustomer.ui.adapter.SlidingImagesURLAdapter
                                    ...
                                    AestheticDialog.Builder(mainActivity, DialogStyle.FLAT, DialogType.SUCCESS)
                                        ...
                                        .setOnClickListener(object : OnDialogClickListener {
                                            override fun onClick(dialog: AestheticDialog.Builder) {
                                                ...
                                                if(resource.data.get(0).response.contains("Already")){
                                                    dialog.dismiss()
                                                }else{
                                                    dialog.dismiss()
                                                    val navController = Navigation.findNavController(binding.root)
